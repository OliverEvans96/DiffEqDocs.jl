...
system up to use [StaticArrays.jl](https://github.com/JuliaArrays/StaticArrays.jl)This is demonstrated [in the ODE tutorial](http://docs.juliadiffeq.org/latest/tutorials/ode_example.html#Example-3:-Using-Other-Types-for-Systems-of-Equations-1)
